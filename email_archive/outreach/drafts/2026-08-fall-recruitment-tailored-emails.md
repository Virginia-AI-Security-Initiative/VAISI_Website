# Fall 2026 External UVA Recruitment Emails

Status: drafts, not confirmed sent  
Distribution: separate official UVA academic, departmental, school, program,
course, or interest lists—not the VAISI announcement list  
Created: August 22, 2026

These drafts intentionally have no VAISI Listserv unsubscribe footer. Before
sending, replace the bracketed forwarding salutation if a list administrator
prefers a short blurb rather than a direct email.

Shared links:

- VAISI: https://vaisi.org
- Club Fair map: https://www.instagram.com/p/DcR23nRiSpy/?igsh=MWEzZGVhMHE1NjN3Yw%3D%3D
- AI Fair RSVP: https://docs.google.com/forms/d/e/1FAIpQLSc_D3s053QVjZ6HQcSa6hglI_pr_mOXrlP9lfZ5NvtZ_pu4Rw/viewform
- Interest Meeting RSVP: https://airtable.com/appM8XoHX2voW3LQe/pag8klHsnJ1stf23q/form
...
This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events, and providing opportunities to engage with research and a community of students interested in the future of AI. No prior AI safety experience is necessary. You can learn more at [vaisi.org](https://vaisi.org).
...
This fall, we are running an Intro to AI Safety Fellowship alongside an AI Policy Fellowship, hosting technical discussions and events, and helping students find ways to engage with AI safety research. You do not need prior AI safety experience to get involved. Learn more at [vaisi.org](https://vaisi.org).
...
This fall, we are running an AI Policy Fellowship as well as an Intro to AI Safety Fellowship, hosting events, and supporting students interested in AI governance research and careers. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events and technical discussions, and helping students engage with relevant research. No prior AI safety background is necessary. Learn more at [vaisi.org](https://vaisi.org).
...
## 5. Political Philosophy, Policy & Law (PPL)
...
VAISI brings together UVA students to study these questions through an AI Policy Fellowship, an Intro to AI Safety Fellowship, events, research, and interdisciplinary discussion. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
## 6. Political & Social Thought (PST)
...
VAISI is a UVA community exploring these issues through an AI Policy Fellowship, an Intro to AI Safety Fellowship, events, research, and interdisciplinary discussion. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
VAISI brings together UVA students to explore the technical, philosophical, and policy challenges posed by advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships alongside events, research, and interdisciplinary discussions. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
VAISI is a UVA community exploring technical and policy approaches to reducing risks from advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events, and supporting student research and discussion. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
This fall, VAISI is running an AI Policy Fellowship as well as an Intro to AI Safety Fellowship, hosting events, and supporting students interested in governance research and careers. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
VAISI is a UVA community exploring technical and policy approaches to reducing risks from advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events and technical discussions, and helping students engage with research. No prior AI safety background is necessary. Learn more at [vaisi.org](https://vaisi.org).
...
## 11. ECE / Computer Engineering / Cybersecurity
...
VAISI is a UVA community exploring technical and policy approaches to reducing risks from advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events, and supporting student research and discussion. No prior AI safety background is necessary. Learn more at [vaisi.org](https://vaisi.org).
...
## 13. Cognitive Science / Psychology / Neuroscience
...
## 15. McIntire / Entrepreneurship / Engineering Business
...
VAISI is a UVA community exploring technical and policy approaches to reducing risks from advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events, and supporting student research and career exploration. No technical background is required. Learn more at [vaisi.org](https://vaisi.org).
...
VAISI is a UVA community exploring technical and policy approaches to reducing risks from advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events and technical discussions, and helping students engage with research. No prior AI or machine learning background is necessary. Learn more at [vaisi.org](https://vaisi.org).
