...
const outreachDefinitions: Array<{
...
}> = [
  {
    ...
    pitch: 'If you are interested in how advanced AI can be made safe and beneficial, we would love to introduce you to the Virginia AI Security Initiative (VAISI). We are a UVA student community focused on reducing risks from advanced AI through technical work, policy, and interdisciplinary discussion.',
  ...
  },
  {
    ...
    pitch: 'If you are interested in securing increasingly capable AI systems, preventing misuse, or understanding the hardware and infrastructure behind frontier AI, we would love to introduce you to the Virginia AI Security Initiative (VAISI). AI safety needs people thinking about system security, control, robustness, compute, and real-world failure modes.',
    programs: 'VAISI is a UVA community exploring technical and policy approaches to reducing risks from advanced AI. This fall, we are running Intro to AI Safety and AI Policy fellowships, hosting events and technical discussions, and helping students engage with research. No prior AI safety background is necessary.',
  },
  {
